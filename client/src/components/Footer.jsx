  ...
  return (
    <div className="fixed h-16 w-full bg-sky-600 bottom-0 flex justify-evenly items-center">
      <div className="flex items-center gap-2">
        {user && (
          <p className="text-xl sm:text-xs font-semibold text-white">
      ...
      <div className="flex items-center gap-2">
        <BsFillCartFill className="text-2xl sm:text-xs text-white" />
        <span className="text-xl sm:text-xs font-semibold text-white">
          Ecommerce devCamp
        </span>
      </div>
      ...
      {isAdminLoggedIn && (
        <>
          <div className="flex items-center gap-2">
            <div
              className="text-4xl sm:text-xs text-white cursor-pointer"
